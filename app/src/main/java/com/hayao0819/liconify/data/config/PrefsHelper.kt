package com.hayao0819.liconify.data.config
...
import com.hayao0819.liconify.data.common.Preferences.ALBUM_ART_ON_LOCKSCREEN_BLUR
import com.hayao0819.liconify.data.common.Preferences.ALBUM_ART_ON_LOCKSCREEN_FILTER
import com.hayao0819.liconify.data.common.Preferences.APP_DRAWER_THEMED_ICONS
import com.hayao0819.liconify.data.common.Preferences.APP_LANGUAGE
import com.hayao0819.liconify.data.common.Preferences.AUTO_UPDATE
import com.hayao0819.liconify.data.common.Preferences.BATTERY_STYLE_CIRCLE
import com.hayao0819.liconify.data.common.Preferences.BATTERY_STYLE_DEFAULT
import com.hayao0819.liconify.data.common.Preferences.BATTERY_STYLE_DEFAULT_LANDSCAPE
import com.hayao0819.liconify.data.common.Preferences.BATTERY_STYLE_DEFAULT_RLANDSCAPE
import com.hayao0819.liconify.data.common.Preferences.BATTERY_STYLE_DOTTED_CIRCLE
import com.hayao0819.liconify.data.common.Preferences.BATTERY_STYLE_FILLED_CIRCLE
import com.hayao0819.liconify.data.common.Preferences.BATTERY_STYLE_LANDSCAPE_BATTERYA
import com.hayao0819.liconify.data.common.Preferences.BATTERY_STYLE_LANDSCAPE_BATTERYI
import com.hayao0819.liconify.data.common.Preferences.BATTERY_STYLE_LANDSCAPE_BATTERYJ
import com.hayao0819.liconify.data.common.Preferences.BATTERY_STYLE_LANDSCAPE_BATTERYL
import com.hayao0819.liconify.data.common.Preferences.BATTERY_STYLE_LANDSCAPE_BATTERYM
import com.hayao0819.liconify.data.common.Preferences.BATTERY_STYLE_LANDSCAPE_BATTERYO
import com.hayao0819.liconify.data.common.Preferences.BATTERY_STYLE_LANDSCAPE_IOS_16
import com.hayao0819.liconify.data.common.Preferences.BATTERY_STYLE_LANDSCAPE_KIM
...
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_BLEND_COLOR
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_CHARGING_COLOR
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_CHARGING_ICON_MARGIN_LEFT
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_CHARGING_ICON_MARGIN_RIGHT
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_CHARGING_ICON_STYLE
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_CHARGING_ICON_SWITCH
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_CHARGING_ICON_WIDTH_HEIGHT
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_DIMENSION
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_FILL_ALPHA
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_FILL_COLOR
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_FILL_GRAD_COLOR
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_HEIGHT
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_HIDE_BATTERY
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_HIDE_PERCENTAGE
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_INSIDE_PERCENTAGE
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_LAYOUT_REVERSE
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_MARGIN_BOTTOM
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_MARGIN_LEFT
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_MARGIN_RIGHT
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_MARGIN_TOP
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_PERIMETER_ALPHA
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_POWERSAVE_FILL_COLOR
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_POWERSAVE_INDICATOR_COLOR
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_RAINBOW_FILL_COLOR
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_STYLE
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_SWAP_PERCENTAGE
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_BATTERY_WIDTH
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_DEPTH_WALLPAPER_SWITCH
import com.hayao0819.liconify.data.common.Preferences.CUSTOM_QS_TEXT_COLOR
import com.hayao0819.liconify.data.common.Preferences.DEPTH_WALLPAPER_AI_MODE
import com.hayao0819.liconify.data.common.Preferences.DEPTH_WALLPAPER_AI_STATUS
import com.hayao0819.liconify.data.common.Preferences.DEPTH_WALLPAPER_BACKGROUND_MOVEMENT_MULTIPLIER
import com.hayao0819.liconify.data.common.Preferences.DEPTH_WALLPAPER_FADE_ANIMATION
import com.hayao0819.liconify.data.common.Preferences.DEPTH_WALLPAPER_FOREGROUND_MOVEMENT_MULTIPLIER
import com.hayao0819.liconify.data.common.Preferences.DEPTH_WALLPAPER_ON_AOD
import com.hayao0819.liconify.data.common.Preferences.DEPTH_WALLPAPER_PARALLAX_EFFECT
import com.hayao0819.liconify.data.common.Preferences.DUALTONE_QSPANEL
import com.hayao0819.liconify.data.common.Preferences.FIXED_STATUS_ICONS_SIDEMARGIN
...
import com.hayao0819.liconify.data.common.Preferences.FLUID_NOTIF_TRANSPARENCY
import com.hayao0819.liconify.data.common.Preferences.FLUID_POWERMENU_TRANSPARENCY
import com.hayao0819.liconify.data.common.Preferences.FLUID_QSPANEL
import com.hayao0819.liconify.data.common.Preferences.FORCE_THEMED_ICONS
import com.hayao0819.liconify.data.common.Preferences.HEADER_CLOCK_COLOR_CODE_ACCENT1
import com.hayao0819.liconify.data.common.Preferences.HEADER_CLOCK_COLOR_CODE_ACCENT2
import com.hayao0819.liconify.data.common.Preferences.HEADER_CLOCK_COLOR_CODE_ACCENT3
import com.hayao0819.liconify.data.common.Preferences.HEADER_CLOCK_COLOR_CODE_TEXT1
import com.hayao0819.liconify.data.common.Preferences.HEADER_CLOCK_COLOR_CODE_TEXT2
import com.hayao0819.liconify.data.common.Preferences.HEADER_CLOCK_COLOR_SWITCH
import com.hayao0819.liconify.data.common.Preferences.HEADER_CLOCK_EXPANSION_Y
import com.hayao0819.liconify.data.common.Preferences.HEADER_CLOCK_LANDSCAPE_SWITCH
...
import com.hayao0819.liconify.data.common.Preferences.LIGHT_QSPANEL
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_SHADE_SWITCH
...
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_BIG_ACTIVE
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_BIG_ICON_ACTIVE
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_BIG_ICON_INACTIVE
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_BIG_INACTIVE
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_CUSTOM_COLOR
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_DEVICE_WIDGET
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_DEVICE_WIDGET_CIRCULAR_COLOR
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_DEVICE_WIDGET_CUSTOM_COLOR_SWITCH
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_DEVICE_WIDGET_DEVICE_NAME
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_DEVICE_WIDGET_LINEAR_COLOR
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_DEVICE_WIDGET_STYLE
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_DEVICE_WIDGET_TEXT_COLOR
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_SMALL_ACTIVE
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_SMALL_ICON_ACTIVE
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_SMALL_ICON_INACTIVE
import com.hayao0819.liconify.data.common.Preferences.LOCKSCREEN_WIDGETS_SMALL_INACTIVE
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_BOTTOMMARGIN
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_COLOR_CODE_ACCENT1
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_COLOR_CODE_ACCENT2
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_COLOR_CODE_ACCENT3
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_COLOR_CODE_TEXT1
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_COLOR_CODE_TEXT2
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_COLOR_SWITCH
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_DEVICENAME
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_FONT_LINEHEIGHT
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_FONT_SWITCH
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_FONT_TEXT_SCALING
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_MOVE_NOTIFICATION_ICONS
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_STYLE
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_SWITCH
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_TOPMARGIN
import com.hayao0819.liconify.data.common.Preferences.LSCLOCK_USERNAME
import com.hayao0819.liconify.data.common.Preferences.NEW_UPDATE_FOUND
import com.hayao0819.liconify.data.common.Preferences.NOTIF_TRANSPARENCY_SWITCH
import com.hayao0819.liconify.data.common.Preferences.OP_QS_HEADER_BLUR_LEVEL
import com.hayao0819.liconify.data.common.Preferences.OP_QS_HEADER_SHOW_ARTWORK
import com.hayao0819.liconify.data.common.Preferences.PREF_KEY_UPDATE_STATUS
import com.hayao0819.liconify.data.common.Preferences.QSALPHA_LEVEL
...
import com.hayao0819.liconify.data.common.Preferences.SB_CLOCK_SIZE
import com.hayao0819.liconify.data.common.Preferences.SB_CLOCK_SIZE_SWITCH
...
import com.hayao0819.liconify.data.common.Preferences.WEATHER_ICON_PACK
...
import com.hayao0819.liconify.data.common.Preferences.WEATHER_TEXT_COLOR
import com.hayao0819.liconify.data.common.Preferences.WEATHER_TEXT_COLOR_SWITCH
import com.hayao0819.liconify.data.common.Preferences.WEATHER_UNITS
import com.hayao0819.liconify.data.common.Preferences.WEATHER_UPDATE_INTERVAL
import com.hayao0819.liconify.data.common.Preferences.WEATHER_YANDEX_KEY
import com.hayao0819.liconify.data.common.Preferences.XPOSED_HOOK_CHECK
import com.hayao0819.liconify.data.common.Resources.shouldShowRebootDialog
import com.hayao0819.liconify.data.config.RPrefs.getBoolean
import com.hayao0819.liconify.data.config.RPrefs.getInt
import com.hayao0819.liconify.data.config.RPrefs.getSliderFloat
import com.hayao0819.liconify.data.config.RPrefs.getString
import com.hayao0819.liconify.data.config.RPrefs.getStringSet
import com.hayao0819.liconify.ui.preferences.TwoTargetSwitchPreference
