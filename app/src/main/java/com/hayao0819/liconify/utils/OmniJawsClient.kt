...
class OmniJawsClient(private val mContext: Context) {
    ...
    companion object {
        ...
        val WEATHER_URI
                : Uri = Uri.parse("content://com.hayao0819.liconify.weatherprovider/weather")
        val SETTINGS_URI
                : Uri = Uri.parse("content://com.hayao0819.liconify.weatherprovider/settings")
        val CONTROL_URI
                : Uri = Uri.parse("content://com.hayao0819.liconify.weatherprovider/control")
